...
public class PaymentsEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (paymentsName != null ? !paymentsName.equals(that.paymentsName) : that.paymentsName != null) return false;
        if (paymentsDescription != null ? !paymentsDescription.equals(that.paymentsDescription) : that.paymentsDescription != null)
            return false;
