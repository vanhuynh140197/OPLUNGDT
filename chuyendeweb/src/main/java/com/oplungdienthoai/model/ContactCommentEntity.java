...
public class ContactCommentEntity {
	...
	public boolean equals(Object o) {
		...
		if (contactId != null ? !contactId.equals(that.contactId) : that.contactId != null)
			return false;
		if (titleContact != null ? !titleContact.equals(that.titleContact) : that.titleContact != null)
			return false;
		if (descriptions != null ? !descriptions.equals(that.descriptions) : that.descriptions != null)
			return false;
		if (dateContacts != null ? !dateContacts.equals(that.dateContacts) : that.dateContacts != null)
			return false;
