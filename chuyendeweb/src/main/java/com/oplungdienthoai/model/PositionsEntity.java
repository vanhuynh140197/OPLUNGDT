...
public class PositionsEntity {
	...
	public boolean equals(Object o) {
		...
		if (positonsId != null ? !positonsId.equals(that.positonsId) : that.positonsId != null)
			return false;
		if (ordersId != null ? !ordersId.equals(that.ordersId) : that.ordersId != null)
			return false;
		if (employeesId != null ? !employeesId.equals(that.employeesId) : that.employeesId != null)
			return false;
		if (dateShipping != null ? !dateShipping.equals(that.dateShipping) : that.dateShipping != null)
			return false;
