...
public class OrdersEntity {
	...
	public boolean equals(Object o) {
		...
		if (Double.compare(that.totalPrices, totalPrices) != 0)
			return false;
		...
		if (customersId != null ? !customersId.equals(that.customersId) : that.customersId != null)
			return false;
		if (orderDescriptions != null ? !orderDescriptions.equals(that.orderDescriptions)
				: that.orderDescriptions != null)
			return false;
		...
		if (paymentsId != null ? !paymentsId.equals(that.paymentsId) : that.paymentsId != null)
			return false;
		if (ordersStatus != null ? !ordersStatus.equals(that.ordersStatus) : that.ordersStatus != null)
			return false;
