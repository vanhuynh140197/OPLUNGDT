...
<body>
	...
	<div class="container">
		<a href="index.html" class="navbar-brand home"><img
			src="img/logo.png" alt="Obaju logo" class="d-none d-md-inline-block"><img
					...
					<ul class="dropdown-menu megamenu">
						<li>
							<div class="row">
								...
								<div class="col-md-6 col-lg-3">
									<div class="banner">
										<a href="#"><img src="img/banner.jpg" alt=""
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li aria-current="page" class="breadcrumb-item active">Blog
								listing</li>
						</ol>
						</nav>
					</div>
					...
					<div id="blog-listing" class="col-lg-9">
						...
						<div class="post">
							...
							<p class="date-comments">
								<a href="post.html"><i class="fa fa-calendar-o"></i> June
									20, 2013</a><a href="post.html"><i class="fa fa-comment-o"></i>
									8 Comments</a>
							</p>
							<div class="image">
								<a href="post.html"><img src="img/blog2.jpg"
									alt="Example blog post alt" class="img-fluid"></a>
							</div>
						...
						<div class="post">
							...
							<div class="image">
								<a href="post.html"><img src="img/blog.jpg"
									alt="Example blog post alt" class="img-fluid"></a>
							</div>
							<p class="intro">Pellentesque habitant morbi tristique
								senectus et netus et malesuada fames ac turpis egestas.
						...
						<div class="pager d-flex justify-content-between">
							...
							<div class="next disabled">
								<a href="#" class="btn btn-outline-secondary disabled">Newer
									→ </a>
							</div>
						</div>
					</div>
						...
						<div class="card sidebar-menu mb-4">
							...
							<div class="card-body">
								<ul class="nav flex-column nav-pills">
									...
									<li><a href="blog.html" class="nav-link">News and
											gossip</a></li>
