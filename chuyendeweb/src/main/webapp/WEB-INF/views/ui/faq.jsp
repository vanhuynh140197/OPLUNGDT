              ...
              -->
						<div class="card sidebar-menu mb-4">
							...
							<div class="card-body">
								<ul class="nav nav-pills flex-column">
									...
									<li><a href="contact.html" class="nav-link">Contact
											page</a></li>
					...
					<div class="col-lg-9">
						<div id="contact" class="box">
							...
							<p>Please feel free to contact us, our customer service
									...
									<div id="headingOne" class="card-header p-0 border-0">
										<h4 class="mb-0">
											<a href="#" data-toggle="collapse" data-target="#collapseOne"
												...
												class="btn btn-primary d-block text-left rounded-0">1.
												What to do if I have still not received the order?</a>
										</h4>
									</div>
									...
									<div id="headingTwo" class="card-header p-0 border-0">
										<h4 class="mb-0">
											<a href="#" data-toggle="collapse" data-target="#collapseTwo"
												...
												class="btn btn-primary d-block text-left rounded-0">2.
												What are the postal rates?</a>
										</h4>
									</div>
									...
									<div id="headingThree" class="card-header p-0 border-0">
										<h4 class="mb-0">
											<a href="#" data-toggle="collapse"
												...
												class="btn btn-primary d-block text-left rounded-0">3.
												Do you send overseas?</a>
										</h4>
									</div>
