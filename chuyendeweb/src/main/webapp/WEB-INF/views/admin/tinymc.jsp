								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Text Editor</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="tinymce-single responsive-mg-b-30">
							<div class="alert-title">
								...
								<p>The fastest way to get Summernote WYSIWYG editor is
									powerfull JavaScript plugin. you can easily maintance
									typography system.</p>
							</div>
						...
						<div class="tinymce-single">
							...
							<div id="summernote2">
								<div class="note-editable panel-body" contenteditable="true"
									style="height: 200px;">
									<h2
										style="font-family: &amp; quot; Open Sans&amp;quot; , sans-serif; font-size: 20px;">
										<span style="font-weight: bold;">Summernote WYSIWYG
											editor</span>
									</h2>
									<p
										style="color: rgb(51, 51, 51); font-size: 14px; line-height: 24px;">The
										fastest way to get Summernote WYSIWYG editor is powerfull
										JavaScript plugin. you can easily maintance typography system</p>
									<p style="font-size: 14px; line-height: 24px;">
										<span style="color: rgb(206, 0, 0);">The fastest way to
											get Summernote WYSIWYG editor is powerfull JavaScript plugin.
											you can easily maintance typography system</span> <br>
									</p>
								</div>
							</div>
						</div>
							...
							<div id="summernote4">
								<ul>
									...
									<li style="text-align: center;">
										<h2
											style="text-align: center; font-family: &amp; quot; Open Sans&amp;quot; , sans-serif; color: rgb(51, 51, 51); font-size: 20px;">Summernote
											WYSIWYG editor</h2>
										<p
											style="text-align: center; font-family: &amp; quot; Open Sans&amp;quot; , sans-serif; color: rgb(51, 51, 51); font-size: 20px;">
											<span style="font-size: 14px; text-align: start;">The
												fastest way to get Summernote WYSIWYG editor is powerfull
												JavaScript plugin. you can easily maintance typography
												system.</span> <br>
										</p>
									</li>
								</ul>
