...
<title>Modals | Kiaalap - Kiaalap Admin Template</title>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Modals</span></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="tab-content-details shadow-reset">
							...
							<p>These are the Custom Animate Modals Bootstrap. Using
								animate bounce, flash, pulse, rubberBand, shake, swing, tada,
								...
								fadeInUp, fadeInUpBig, flipInX, flipInY, lightSpeedIn, rotateIn,
								rotateInDownLeft, rotateInDownRight, rotateInUpLeft,
								rotateInUpRight, rollIn, zoomIn, zoomInDown, zoomInLeft,
								zoomInRight, zoomInUp etc.</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div
							class="modal-bootstrap shadow-inner mg-tb-30 responsive-mg-b-0">
							<h2>Alert Modal</h2>
							<p>Bootstrap provides an easy way to create predefined alert
								messages. They support a number of use cases from user
								notification to completely custom content and feature a handful
								of helpful subcomponents, sizes, and more.</p>
							<div class="modal-area-button">
								<a class="Primary mg-b-10" href="#" data-toggle="modal"
									data-target="#PrimaryModalalert">Primary</a> <a
									class="Information Information-color mg-b-10" href="#"
									data-toggle="modal" data-target="#InformationproModalalert">Information</a>
								<a class="Warning Warning-color mg-b-10" href="#"
									data-toggle="modal" data-target="#WarningModalalert">Warning</a>
								<a class="Danger danger-color" href="#" data-toggle="modal"
									data-target="#DangerModalalert">Danger</a>
							</div>
						</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="modal-bootstrap shadow-inner mg-tb-30">
							...
							<div class="modal-area-button">
								<a class="Primary mg-b-10" href="#" data-toggle="modal"
									data-target="#PrimaryModalftblack">Primary</a> <a
									class="Information Information-color mg-b-10" href="#"
									data-toggle="modal" data-target="#InformationproModalftblack">Information</a>
								<a class="Warning Warning-color mg-b-10" href="#"
									data-toggle="modal" data-target="#WarningModalftblack">Warning</a>
								<a class="Danger danger-color" href="#" data-toggle="modal"
									data-target="#DangerModalftblack">Danger</a>
							</div>
						</div>
						...
						<div id="InformationproModalftblack"
						...
						<div id="DangerModalftblack"
							class="modal modal-edu-general FullColor-popup-DangerModal PrimaryModal-bgcolor fade"
							role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-close-area modal-close-df">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="modal-bootstrap shadow-inner res-mg-b-30">
							...
							<div class="modal-area-button">
								<a class="Primary mg-b-10" href="#" data-toggle="modal"
									data-target="#PrimaryModalhdbgcl">Primary</a> <a
									class="Information Information-color mg-b-10" href="#"
									data-toggle="modal" data-target="#InformationproModalhdbgcl">Information</a>
								<a class="Warning Warning-color mg-b-10" href="#"
									data-toggle="modal" data-target="#WarningModalhdbgcl">Warning</a>
								<a class="Danger danger-color" href="#" data-toggle="modal"
									data-target="#DangerModalhdbgcl">Danger</a>
							</div>
						</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="modal-bootstrap shadow-inner">
							...
							<div class="modal-area-button">
								<a class="Primary mg-b-10" href="#" data-toggle="modal"
									data-target="#PrimaryModalblbgpro">Primary</a> <a
									class="Information Information-color mg-b-10" href="#"
									data-toggle="modal" data-target="#InformationproModalblbgpro">Information</a>
								<a class="Warning Warning-color mg-b-10" href="#"
									data-toggle="modal" data-target="#WarningModalblbgpro">Warning</a>
								<a class="Danger danger-color" href="#" data-toggle="modal"
									data-target="#DangerModalblbgpro">Danger</a>
							</div>
						</div>
						<div id="PrimaryModalblbgpro"
							class="modal modal-edu-general default-popup-PrimaryModal PrimaryModal-bgcolor fade"
							role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
