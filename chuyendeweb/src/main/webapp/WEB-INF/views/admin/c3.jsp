								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">C3 Charts</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="about-sparkline responsive-mg-b-30">
							...
							<div class="sparkline-content">
								<p>C3 makes it easy to generate D3-based charts by wrapping
									the code required to construct the entire chart. We don't need
									to write D3 code any more.</p>
								<p>C3 gives some classes to each element when generating, so
									you can define a custom style by the class and it's possible to
									extend the structure directly by D3.</p>
								<p>C3 provides a variety of APIs and callbacks to access the
									state of the chart. By using them, you can update the chart
									even after it's rendered.</p>
								<p class="table-dis-n-pro dk-res-t-d-n">
									c3 is a D3-based reusable chart library <span
										class="c3-align-dlt">that enables deeper integration of
										charts into web applications.</span>
								</p>
								<a target="_blank" href="http://c3js.org/examples.html">Read
									More</a>
							</div>
						</div>
					</div>
						...
						<div class="sparkline-list">
							<div class="smart-sparkline-hd">
								<div class="smart-main-spark-hd">
									<h1>
										C3 Line <span class="c3-ds-n">Charts With</span> custom <span
											class="c3-ds-n">colors</span>
									</h1>
								</div>
							</div>
						...
						<div class="sparkline7-list responsive-mg-b-30">
							<div class="sparkline7-hd">
								<div class="main-spark7-hd">
									<h1>
										Line & Bar <span class="c3-ds-n">Chart Example</span>
									</h1>
								</div>
							</div>
						...
						<div class="sparkline8-list">
							<div class="sparkline8-hd">
								<div class="main-sparkline8-hd">
									<h1>
										Bar Big size <span class="c3-ds-n">Example</span>
									</h1>
								</div>
							</div>
