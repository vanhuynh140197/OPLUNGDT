							...
							<div class="panel-body">
								...
								<ul class="mailbox-list">
									<li class="active"><a href="#"> <span
											class="pull-right">12</span> <i class="fa fa-envelope"></i>
											Inbox
									</a></li>
								...
								<div class="text-center p-xs font-normal">
									<div class="input-group">
										<input type="text" class="form-control input-sm"
											...
											class="input-group-btn active-hook">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6 col-md-6 col-sm-6 col-xs-8">
										<div
											class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
									...
									<div
										class="col-md-6 col-md-6 col-sm-6 col-xs-4 mailbox-pagination">
										<div
											class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
											<button class="btn btn-default btn-sm">
									...
									<table class="table table-hover table-mailbox">
										<tbody>
											...
											<tr class="active">
												...
												<td><a href="#">Etiam maximus tellus a turpis
														tempor mollis.</a></td>
												<td></td>
											...
											<tr>
												...
												<td><a href="#">Quisque eu tortor quis justo
														viverra cursus.</a></td>
												<td></td>
											...
											<tr>
												...
												<td><a href="#">Aliquam nec justo interdum, ornare
														mi non, elementum lacus.</a></td>
												<td><i class="fa fa-paperclip"></i></td>
											...
											<tr>
												...
												<td><a href="#">Quisque quis turpis ac quam
														sagittis scelerisque vel ut urna.</a></td>
												<td></td>
