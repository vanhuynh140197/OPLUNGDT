								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">X-editable</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="x-editable-list">
							<div class="alert-title">
								<h2>X-editable</h2>
								<p>There are a few classes working together for editable.
									Base class editableform is form with single input and two
									buttons. Input can be one of several input types (text,
									textarea, etc). Form markup is performed in plain HTML or can
									be extended by some library (bootstrap, jquery-ui).
									editableContainer includes editableform and shows it in popup
									or inline mode. When popup it can use any container for display
									(popover, tooltip, etc). Final class editable binds
									editableContainer to DOM element storing value and being
									updated after user submits new value.</p>
							</div>
							<table id="user"
								class="table table-bordered table-striped x-editor-custom">
								<tbody>
									<tr>
										<td>Simple text field</td>
										<td><a href="#" id="username" data-type="text"
									...
									<tr>
										...
										<td><a href="#" id="status" data-type="select"
											data-pk="1" data-value="0" data-source="/status"
									...
									<tr>
										...
										<td><a href="#" id="meeting_start" data-type="datetime"
											data-pk="1" data-url="/post" data-placement="right"
											title="Set date & time">15/03/2013 12:45</a></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><a href="#" id="tags" data-type="select2" data-pk="1"
											data-title="Enter tags">html, javascript</a></td>
									</tr>
									<tr>
										<td>Select2 (dropdown mode)</td>
										<td><a href="#" id="country" data-type="select2"
											data-pk="1" data-value="BS" data-title="Select country"></a>
										</td>
									</tr>
								</tbody>
							</table>
