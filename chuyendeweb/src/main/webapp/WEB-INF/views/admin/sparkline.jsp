								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Sparkline</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<div class="about-sparkline responsive-mg-b-30">
							...
							<div class="sparkline-content">
								<p>This jQuery plugin generates sparklines (small inline
									charts) directly in the browser using data supplied either
									inline in the HTML, or via javascript.You need to include both
									on your page to generate sparklines.</p>
								<p>
									The plugin is compatible with most modern browsers and has been
									tested with <span class="table-dis-n-pro dk-res-t-d-n">Firefox
										2+, Safari 3+, Opera 9, Google Chrome and Internet Explorer 6,
										7, 8, 9 & 10 as well as Android.</span>
								</p>
								<a target="_blank"
									href="https://omnipotent.net/jquery.sparkline/#s-about">Read
									More</a>
							</div>
						</div>
					</div>
							...
							<div class="smart-sparkline-list">
								<table class="table table-bordered table-edu">
									...
									<tbody>
										...
										<tr>
											<td><span class="sparklineedu"></span></td>
											<td>Bar chart Positive</td>
										</tr>
										<tr>
