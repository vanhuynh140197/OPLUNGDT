...
<title>Preloader | Kiaalap - Kiaalap Admin Template</title>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Preloader</span></li>
										</ul>
									</div>
								</div>
							</div>
		...
		<div class="preloader-area mg-b-15">
			<div class="container-fluid">
						...
						<div class="preloader-single shadow-inner res-mg-b-30">
							<div class="ts_preloading_box">
								<div id="ts-preloader-absolute07">
									...
									<div class="tsperloader7" id="tsperloader7_two"
										style="left: 20px;"></div>
									<div class="tsperloader7" id="tsperloader7_three"
										style="left: 40px;"></div>
									<div class="tsperloader7" id="tsperloader7_four"
										style="left: 60px;"></div>
									<div class="tsperloader7" id="tsperloader7_five"
										style="left: 80px;"></div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<div
							class="preloader-single shadow-inner mg-tb-30 responsive-mg-b-0">
							<div class="ts_preloading_box">
						...
						<div class="preloader-single shadow-inner mg-tb-30">
							<div class="ts_preloading_box">
								<div id="ts-preloader-absolute12">
									...
									<div class="tsperloader12" id="second_tsperloader12"
