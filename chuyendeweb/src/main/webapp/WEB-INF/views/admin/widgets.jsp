							...
							<div class="panel-body">
								...
								<div class="m-t-xl widget-cl-1">
									...
									<small> Lorem Ipsum is simply dummy text of the
										printing and Lorem <strong>typesetting industry</strong> spa.
									</small>
								</div>
							</div>
						</div>
						...
						<div class="hpanel widget-int-shape responsive-mg-b-30">
							<div class="panel-body">
								<div class="text-center content-box">
									...
									<p class="small mg-t-box">Lorem Ipsum passages and more
										recently with the desktop published software like Aldus
										PageMaker.</p>
									<button class="btn btn-success widget-btn-1 btn-sm">Action
										button</button>
								</div>
							</div>
						</div>
							...
							<div class="panel-body">
								<div class="text-center content-box">
									...
									<p class="small mg-t-box">Lorem Ipsum passages and more
										recently with the desktop published software like Aldus
										PageMaker.</p>
									<button class="btn btn-info widget-btn-2 btn-sm">Action
										button</button>
								</div>
							</div>
						</div>
							...
							<div class="panel-body">
								<div class="text-center content-box">
									...
									<p class="small mg-t-box">Lorem Ipsum passages and more
										recently with the desktop published software like Aldus
										PageMaker.</p>
									<button class="btn btn-warning widget-btn-3 btn-sm">Action
										button</button>
								</div>
							</div>
						</div>
							...
							<div class="panel-body">
								<div class="text-center content-box">
									...
									<p class="small mg-t-box">Lorem Ipsum passages and more
										recently with the desktop published software like Aldus
										PageMaker.</p>
									<button class="btn btn-danger widget-btn-4 btn-sm">Action
										button</button>
								</div>
							</div>
						</div>
						...
						<div class="hpanel shadow-inner hbggreen bg-1 responsive-mg-b-30">
							<div class="panel-body">
								<div class="text-center content-bg-pro">
									...
									<small> Lorem Ipsum passages and more recently with
										desktop published software. </small>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="panel-body">
								<div class="table-responsive wd-tb-cr">
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												<td><span class="text-success font-bold">Lorem
														ipsum</span></td>
												<td>Jul 14, 2013</td>
											</tr>
											<tr>
							...
							<div class="panel-body">
								<div class="table-responsive wd-tb-cr">
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												<td><span class="text-info font-bold">Lorem
														ipsum</span></td>
												<td>Jul 14, 2013</td>
											</tr>
											<tr>
							...
							<div class="panel-body">
								<div class="table-responsive wd-tb-cr">
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												<td><span class="text-warning font-bold">Lorem
														ipsum</span></td>
												<td>Jul 14, 2013</td>
											</tr>
											<tr>
							...
							<div class="panel-body">
								<div class="table-responsive wd-tb-cr">
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												<td><span class="text-danger font-bold">Lorem
														ipsum</span></td>
												<td>Jul 14, 2013</td>
											</tr>
											<tr>
