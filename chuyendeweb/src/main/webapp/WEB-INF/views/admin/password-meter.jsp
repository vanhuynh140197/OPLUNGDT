								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Password Meter</span></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="sparkline12-list responsive-mg-b-30">
							<div class="sparkline12-hd">
								<div class="main-sparkline12-hd">
									<h1>
										Basic Password <span class="password-mt-none">Meter
											Example</span>
									</h1>
								</div>
							</div>
								...
								<div id="pwd-container1">
									<div class="form-group">
										<label for="password1">Password</label> <input type="password"
											...
											placeholder="Password" value="Passwo">
									</div>
						...
						<div class="sparkline11-list">
							<div class="sparkline11-hd">
								<div class="main-sparkline11-hd">
									<h1>
										Show <span class="password-mt-none">the</span> password <span
											class="password-mt-none">strength</span>
									</h1>
								</div>
							</div>
								...
								<div id="pwd-container2">
									<div class="form-group head-strong-password">
										<label for="password2">Password</label> <input type="password"
											class="form-control example2" id="password2"
						...
						<div class="sparkline12-list mg-t-30 responsive-mg-b-0">
							<div class="sparkline10-hd">
								<div class="main-sparkline10-hd">
									<h1>
										Interact <span class="password-mt-none">with other</span>
										inputs
									</h1>
								</div>
							</div>
								...
								<div id="pwd-container3">
									...
									<div class="form-group">
										<label for="password3">Password</label> <input type="password"
											class="form-control example3" id="password3"
						...
						<div class="sparkline9-list mg-t-30">
							<div class="sparkline9-hd">
								<div class="main-sparkline9-hd">
									<h1>
										Calculate <span class="password-mt-none">the</span> password <span
											class="password-mt-none">strength</span>
									</h1>
								</div>
							</div>
							<div class="sparkline9-graph">
								<div id="pwd-container4">
									<div class="form-group">
										<label for="year">Year of birth</label> <input type="text"
											class="form-control" id="year" value="2018">
									</div>
									<div class="form-group">
										<label for="familyname">Username</label> <input type="text"
											class="form-control" id="familyname" placeholder="Name"
											value="md.roshid">
									</div>
									<div class="form-group">
										<label for="password4">Password</label> <input type="password"
											class="form-control example4" id="password4"
											placeholder="Password">
									</div>
									<div class="form-group mg-b-pass">
										<span class="font-bold pwstrength_viewport_verdict4"></span> <span
