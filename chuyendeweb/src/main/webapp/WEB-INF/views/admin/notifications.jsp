								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Notification</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Notifications Disable sound Can be closed by clicking on
									it.</p>
							</div>
							<div class="notification-bt responsive-btn">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Notifications Custom title Can be closed by clicking on
									it.</p>
							</div>
							<div class="notification-bt responsive-btn">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Notifications Without icon and image Can be closed by
									clicking on it.</p>
							</div>
							<div class="notification-bt responsive-btn">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Notifications Increase delay time Can be closed by
									clicking on it.</p>
							</div>
							<div class="notification-bt responsive-btn">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Notifications Sticky (without delay) Can be closed by
									clicking on it.</p>
							</div>
							<div class="notification-bt responsive-btn">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Notifications Alternative position Can be closed by
									clicking on it.</p>
							</div>
							<div class="notification-bt responsive-btn">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Notifications Custom Width Can be closed by clicking on
									it.</p>
							</div>
							<div class="notification-bt responsive-btn">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="notification-list shadow-inner nt-mg-b-30">
							<div class="alert-title">
								...
								<p>Can be closed by clicking on it. You can use any
									animate.css classes</p>
							</div>
							<div class="notification-bt responsive-btn">
