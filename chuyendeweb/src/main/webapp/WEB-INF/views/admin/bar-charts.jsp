								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Bar Charts</span></li>
										</ul>
									</div>
								</div>
							</div>
		...
		<div class="charts-area mg-b-15">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div
							class="charts-single-pro mg-t-30 responsive-mg-b-0 table-mg-btm-0-pro dk-mg-b-0-desk">
							<div class="alert-title">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div
							class="charts-single-pro mg-t-30 table-mg-btm-0-pro dk-mg-b-0-desk">
							<div class="alert-title">
								<h2>Bar Chart Multi axis</h2>
								<p>
									This sample illustrates how you can display a data series,
									using multiple axes in your business chart. It is sometimes
									used to show trend data, and the comparison <span
										class="bar-mini-ds">of multiple data sets</span>
								</p>
							</div>
							<div id="bar4-chart">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div
							class="charts-single-pro table-dis-n-pro dk-res-t-d-n chart-ds-n-ex">
							<div class="alert-title">
