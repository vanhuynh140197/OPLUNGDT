...
<title>Peity | Kiaalap - Kiaalap Admin Template</title>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">Peity</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<div class="about-sparkline responsive-mg-b-30">
							...
							<div class="sparkline-content peity-ctn">
								<p>Peity (sounds like deity) is a jQuery plugin that
									converts an element's content into a angle svg mini pie donut
									line or bar chart and is compatible with any browser that
									supports angle svg: Chrome, Firefox, IE9+, Opera, Safari.</p>
								<p class="">
									Passing a radius will set <span
										class="table-dis-n-pro dk-res-t-d-n">the correct width
										and height, the pie will always be a circle that fits the
										available space.</span>
								</p>
								<a target="_blank" href="http://benpickles.github.io/peity/">Read
									More</a>
							</div>
						</div>
					</div>
						...
						<div class="sparkline-list">
							...
							<div class="smart-sparkline-list smart-pie-list peity-res-scroll">
								<table class="table table-bordered table-edu">
									...
									<tbody>
										<tr>
											<td class="code-edu-center"><span class="pie">1/6</span>
											</td>
											<td><code>&lt;span
													class="pie"&gt;1/6&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td class="code-edu-center"><span class="pie">230/360</span>
											</td>
											<td><code>&lt;span
													class="pie"&gt;230/360&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td class="code-edu-center"><span class="pie">0.42/1.461</span>
											</td>
											<td><code>&lt;span
													class="pie"&gt;0.42/1.461&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td class="code-edu-center"><span class="pie">2,7</span>
											</td>
											<td><code>&lt;span
													class="pie"&gt;2,7&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td class="code-edu-center"><span class="pie">236,133</span>
											</td>
											<td><code>&lt;span
													class="pie"&gt;236,133&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td class="code-edu-center"><span class="pie">0.42,1.051</span>
											</td>
											<td><code>&lt;span
													class="pie"&gt;0.42,1.051&lt;/span&gt;</code></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table class="table table-bordered table-edu">
									...
									<tbody>
										<tr>
											...
											<td class="code-edu"><code>&lt;span
													class="line"&gt;2,5,9,6,5,9,7,3,5,2,5,3,9,6,5,8,7,8,5,2&lt;/span&gt;</code>
											</td>
										</tr>
										<tr>
											<td><span class="line">8,5,2,-1,-3,-2,8,3,5,3</span></td>
											<td class="code-edu"><code>&lt;span
													class="line"&gt;8,5,2,-1,-3,-2,8,3,5,3&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td><span class="line">0,-5,-6,-4,-5,-4,-7,-3,-3,-5</span>
											</td>
											<td class="code-edu"><code>&lt;span
													class="line"&gt;0,-5,-6,-4,-5,-4,-7,-3,-3,-5&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td><span class="bar">5,3,9,6,5,9,7,3,5,2</span></td>
											<td class="code-edu"><code>&lt;span
													class="bar"&gt;5,3,9,6,5,9,7,3,5,2&lt;/span&gt;</code></td>
										</tr>
										<tr>
											<td><span class="bar">5,3,2,-1,-3,-2,2,3,5,2</span></td>
											<td class="code-edu"><code>&lt;span
													class="bar"&gt;5,3,2,-1,-3,-2,2,3,5,2&lt;/span&gt;</code></td>
										</tr>
									</tbody>
								</table>
							</div>
